...
class MobileData extends Service
{
    ...
    protected function doSend(array $parameters, array $options = []): array
    {
        ...
        } elseif (isset($parameters['recipients']) && is_array($parameters['recipients'])) {
    ...
    protected function doFindTransaction(array $options): array
    {
    ...
    protected function doFetchWalletBalance(): array
    {
        $requestData = [
            'username' => $this->username,
        ];
